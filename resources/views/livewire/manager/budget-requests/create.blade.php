...
$save = function () {
    ...
    notyf()->success(__('État de besoin détaillé soumis.'));
...
<div>
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">États de Besoin /</span> Nouvelle demande détaillée
    </h4>
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary btn-lg">Soumettre l'État de Besoin</button>
